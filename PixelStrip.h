...
public:
    ...
    stripOff(),
        ...
        fillBgGradientRGB(),
        setRainbowOffset(uint8_t offset),
        setRainbowOffsetCycle(uint32_t offsetFreq, boolean offsetDirct),
        runRainbowOffsetCycle(boolean cycleRun),
        ...
        shooterSeg(SegmentSet segmentSet, uint32_t pallet[], byte palletLength, int32_t BgColor, boolean bgPrefill, uint8_t spawnChance, byte maxNumShooters, int trails, uint8_t trailLength, uint8_t colorMode, boolean direction, boolean alternating, int wait, int numCycles),
        ...
        sparkSeg(SegmentSet segmentSet, byte sparkChance, byte maxSparks, byte numColors, uint32_t prefColor, byte colorMode, uint32_t BgColor, byte BgColorMode, boolean bgPrefill, boolean direction, int numCycles, int wait),
        sparkSegSet(SegmentSet segmentSet, byte sparkChance, byte maxSparks, uint32_t pallet[], uint8_t palletLength, byte colorMode, uint32_t BgColor, byte BgColorMode, boolean bgPrefill, boolean direction, int numCycles, int wait),
...
private:
    ...
    incrementLedLocation(uint16_t localPattern[][3], uint8_t patternLength, uint8_t eyeSize, boolean scanner),
        ...
        genShiftingSeaGroupedOffsetArray(uint16_t pixelOffsets[], uint8_t grouping, uint16_t totalCycleLength),
