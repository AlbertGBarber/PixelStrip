...
void PixelStrip::setRainbowOffset(uint8_t offset)
{
    rainbowOffset = offset;
}

//returns the current rainbow offset amount
uint8_t PixelStrip::getRainbowOffset()
{
...
void PixelStrip::runRainbowOffsetCycle(boolean cycleRun)
{
    rainbowCycleRun = cycleRun;
}
